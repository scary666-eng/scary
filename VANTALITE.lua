loadstring(game:HttpGet("https://raw.githubusercontent.com/raeth231321343/vanta.dev/refs/heads/main/ui%20startup.lua"))()
wait(2.5)
local WindUI
do
...
AboutSection:Space()
AboutSection:Section({
    Title = "Credits for vanta lite",
    TextSize = 18,
    TextTransparency = .35,
    FontWeight = Enum.FontWeight.Medium,
})
AboutSection:Section({
    Title = "kazakori, scrilisk",
    TextSize = 18,
    TextTransparency = .35,
    FontWeight = Enum.FontWeight.Medium,
})
local FarmingTab = Window:Tab({ Title = "Farming", Icon = "skull" })
local StandFarmTab = Window:Tab({ Title = "StandFarm", Icon = "star" })
